...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(max_length=30, null=False, blank=False, default='')
    birth_day =  models.DateField(default=datetime.date(1900, 1, 1))
    image_profile = models.ImageField(upload_to=create_upload_path, blank=True, null=True)
    ...
    REQUIRED_FIELDS = ["birth_day", "username"]
